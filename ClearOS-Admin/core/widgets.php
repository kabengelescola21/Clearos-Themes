...
function theme_login_form($redirect, $languages, $lang, $errmsg, $options = NULL)
{
    ...
    echo field_input('os_username', '', "<i class='fa fa-user'></i> " . lang('base_username'));
    echo field_password('os_password', '', "<i class='fa fa-lock'></i> " . lang('base_password'));
